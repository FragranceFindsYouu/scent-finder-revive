...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Independent fragrance decants and samples by Joan. Try designer and niche scents in mls designer, premium designer,niche,ultra niche, and also indie fragrances." },
      { property: "og:title", content: "Fragrance Finds You — Genuine designer & niche fragrance decants" },
      { property: "og:description", content: "Independent fragrance decants and samples by Joan. Try designer and niche scents in mls designer, premium designer,niche,ultra niche, and also indie fragrances." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Fragrance Finds You — Genuine designer & niche fragrance decants" },
      { name: "twitter:description", content: "Independent fragrance decants and samples by Joan. Try designer and niche scents in mls designer, premium designer,niche,ultra niche, and also indie fragrances." },
    ...
    links: [
      ...
      { rel: "canonical", href: "https://fragrancefindsyou.com/" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Fragrance Finds You",
          alternateName: "FFY",
          url: "https://fragrancefindsyou.com",
          logo: "https://fragrancefindsyou.com/icon-1024.png",
          description:
            "Independent designer & niche fragrance decants and samples by Joan.",
          sameAs: [],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          potentialAction: {
            "@type": "SearchAction",
            target: "https://fragrancefindsyou.com/catalog?q={search_term_string}",
